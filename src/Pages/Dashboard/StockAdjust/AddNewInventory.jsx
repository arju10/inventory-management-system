...
import StockProduct from "./AdjustProduct";
      ...
      <div className="border">
        ...
        <div className=" ps-1 pe-2">
          ...
          <div className="flex gap-5 mt-2  ">
            ...
            <button className="btn btn-sm btn-info btn-wide text-white text-lg">
              <svg
          ...
          <div className="flex gap-2 mt-2">
            <label className="form-control w-full max-w-xs input-sm ">
              <div className="label">
                <span className="label-text">
                  CTN / Bag<span className="text-red-500">*</span>
                </span>
              </div>
              <input
                type="number"
          ...
          <button className="btn btn-sm btn-info btn-wide text-white text-lg mt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="20"
              width="17.5"
