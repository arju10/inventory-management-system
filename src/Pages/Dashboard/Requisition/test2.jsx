...
function Requisition() {
  ...
  return (
      <div className="sm:bg-white sm:p-6 h-screen" > 
        ...
        <div className="container mx-auto flex flex-col items-start">
          <div className="w-full mb-4">
            <div className="flex flex-wrap justify-center sm:justify-start">
              <button onClick={handleButtonClick} className="bg-green-500 text-white px-2 sm:px-4 py-1 sm:py-2 rounded hover:bg-green-600 m-1">
          ...
          <div className="w-full overflow-x-auto">
            ...
            <div className="flex justify-between flex-wrap p-2">
              ...
              <select
                ...
                className="border border-gray-300 rounded p-1 sm:p-2"
              >
