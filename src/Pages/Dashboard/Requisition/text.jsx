        ...
        <div className="w-full mb-4">
          <div className="flex flex-wrap justify-center sm:justify-start">
            <button
              ...
              className="bg-blue-500 text-white px-2 sm:px-4 py-1 sm:py-2 rounded m-1"
            >
              + New Requisition Request
            </button>
            <button className="bg-white text-blue-500 px-2 sm:px-4 py-1 sm:py-2 rounded m-1">
              Preview
            </button>
          </div>
        </div>
        <div className="w-full overflow-x-auto">
          <table className="min-w-full bg-white mb-4">
            <thead className="bg-custom-dark text-white">
              <tr >
                <th className="text-left px-2 py-1 sm:px-4 sm:p-3 border">Date</th>
                ...
                <th className="text-left px-2 py-1 sm:px-4 sm:p-3 border">Note</th>
              </tr>
            </thead>
            <tbody>
              {records.length > 0 ? (
