...
const AddNewSupplier = () => {
  ...
  return (
    <>
      ...
      <div>
        <h1 className='text-xl font-semibold mb-5'>Add New Supplier</h1>
      </div>
      <div className='border-2 pt-5 pb-5 ps-5 pe-5 font-semibold'>
        ...
        <div className='flex gap-5'>
          ...
          <label className='form-control w-full max-w-xs'>
            <div className='label'>
              <span className='label-text'>
                Id/Code<span className='text-red-500'>*</span>
              </span>
            </div>
            <input
              type='text'
          ...
          <label className='label cursor-pointer'>
            ...
            &nbsp;
            <span className='label-text'>
              Manual Code<span className='text-red-500'>*</span>
            </span>
          </label>
        </div>
        ...
        <div className='flex gap-5 mt-5'>
          ...
          <label className='form-control w-full max-w-xs'>
            <div className='label'>
              <span className='label-text'>
                Show Order<span className='text-red-500'>*</span>
              </span>
            </div>
            <input
              type='number'
        ...
        <div className='flex gap-5 mt-5'>
          <label className='form-control w-full max-w-xs'>
            <div className='label'>
              <span className='label-text'>
                Create User?<span className='text-red-500'>*</span>
              </span>
            </div>
            <select
