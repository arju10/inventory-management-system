    ...
    <div className="w-full">
      <div className="navbar bg-blue-600 text-white ">
        <div className="flex-none lg:flex items-center space-x-4 ">
          <button onClick={() => setCollapsed(!collapsed)} className="btn btn-ghost text-white rounded-full">
          ...
          <button className="btn btn-ghost text-white lg:hidden " onClick={handleMobileMenuToggle}>
        ...
        <div className="flex-1 flex justify-end items-center space-x-4">
          ...
          <div className="relative">
            <button className="btn btn-ghost text-white" onClick={handleProfileDropdownToggle}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
      ...
      {isMobileMenuOpen && (
        <div className="bg-blue-600 text-white lg:hidden">
          <div className="p-2">
            <button className="btn btn-ghost w-full text-left text-white">
            ...
            <div className="relative">
              <button className="btn btn-ghost w-full text-left text-white" onClick={handleProfileDropdownToggle}>
                <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
